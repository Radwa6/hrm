        ...
        >
          <div class="data">
            ...
            <span>
              ...
              <p>إدارة ملفات الموارد البشرية</p>
            </span>
            <span>
              <svg
                width="24"
            ...
            <span>
              ...
              <p>إدارة الاجازات الرسمية</p>
            </span>
            <button>اشتراك الان</button>
          </div>
        </div>
        <div
          class="col-sm-4 animate__animated animate__fadeInUp"
          data-il8n="task"
        >
          <div class="blue">
